...
var (
	...
	NO_ACCOUNT_DATA_FOUND  = fmt.Errorf("Account data not found")
	NO_DATA_FOUND          = fmt.Errorf("No data found")
	...
	ErrNoLastUpdate      = fmt.Errorf("no last update of the given user found")
